            ...
            <div class="row">
                ...
                <div class="col-md-4">
                     <form action="login.action" method="post" class="login-form" style="box-shadow: 0px 15px 25px -10px #000000;">
                        <div class="row">
                            <div class="col-md-12"> 
                                    <h3 class="welcome-text text-center">Admin Login</h3> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="E-mail" type="email"  name="email" class="form-control form-control" id="recipient-name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            	<input type="hidden" value="true" name="adminFlag">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="caption2">Don't have an account? <a href="admin-signup.jsp" class="sign-up-text"> Sign up. </a></p>
                            </div>
                        </div>
                        <hr>
                        <div class="text-center mt-2">
                            <i class="text-black fa fa-user"></i> <a class="primary-text" href="login.jsp">USER LOGIN</a>
                        </div>
                    </form>
