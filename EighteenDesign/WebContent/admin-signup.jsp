    ...
    <div class="parallax-login">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <form action="adminSignup"  method="post"  class="login-form" style="box-shadow: 0px 15px 25px -10px #000000;">
                        <div class="row">
                            <div class="col-md-12"> 
                                    <h3 class="welcome-text text-center">Admin Sign Up</h3> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            	<input type="hidden" class="form-control form-control"  name="role" value="ADMIN">
                               <input type="submit"  class="btn btn-gradient btn-block" value="Sign Up">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <p class="caption2"> Already have an account? <a href="admin-login.jsp" class="log-in-text"> Log in. </a></p>
                            </div>
                        </div>
                        <hr>
                        <div class="text-center mt-2">
                            <i class="text-black fa fa-user"></i> <a class="primary-text" href="signup.jsp">USER SIGNUP</a>
                        </div>
                    </form>
