...
<body> 
    ...
    <a href="" class="menu-icn"><i class="fa fa-bars" aria-hidden="true"></i></a>
        ...
        <a class="navbar-brand" href="admin-index.jsp"><img class="img-fluid" src="img/logo.png"></a>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="admin-index.jsp"><i class="fa fa-home"></i> Home</a>
                </li> 
                <li class="nav-item">
            ...
            <form class="form-inline my-2 my-lg-0"> 
                <s:if test="#session.email != null">
           			...
           			<a href="adminLogout" class="pp-up" style="border-left: 1px dotted #888;"><i class="fa fa-user-circle-o" aria-hidden="true"></i>  Log Out </a> 
        		</s:if>
                 <s:if test="#session.email == null">
